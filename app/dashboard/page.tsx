                            ...
                            <div className="relative z-10">
                                ...
                                <div className="mt-10 flex flex-wrap items-center justify-between gap-6 border-t border-white/30 pt-8">
                                    <div className="flex gap-5 items-center">
                                        ...
                                        <a href="https://www.facebook.com/nguyen.khanh.linh.497701/" className="w-12 h-12 flex items-center justify-center rounded-full bg-white/40 text-[#4a3728] border border-white/20 hover:bg-[#d85165] hover:text-white transition-all shadow-md group">
                                        ...
                                        <a href="https://www.instagram.com/nlinhh122/" className="w-12 h-12 flex items-center justify-center rounded-full bg-white/40 text-[#4a3728] border border-white/20 hover:bg-[#d85165] hover:text-white transition-all shadow-md group">
